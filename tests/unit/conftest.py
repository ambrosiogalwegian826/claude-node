...
@pytest.fixture
def make_controller(controller_cls):
    def _make(**kwargs):
        ctrl = controller_cls(skip_permissions=True, **kwargs)
        return ctrl
    return _make


@pytest.fixture
def live_controller(make_controller, fake_process):
    ctrl = make_controller()
    ctrl._proc = fake_process
    return ctrl
